				...
				<Grid item lg={4} sm={12} xs={12}>
					<div className='paper paper2'>
						...
						<Typography>
							...
							veritatis illum voluptates quas corrupti quia itaque at aliquid.
							Quas voluptate architecto fugiat eius sunt accusamus magni
							doloribus officia voluptates perspiciatis.
						</Typography>
					</div>
				</Grid>
				<Grid item lg={4} sm={12} xs={12}>
